...
±±ºPrograma  ³ ABATFR02 º Autor ³ Leonardo Soncin    º Data ³  31/08/11   º±±
...
Local nLin			:= 80
Local Cabec1		:= "                                                                                  Informações do Inventário                                             Informações do ERP"
Local Cabec2		:= "Emissão     Cód. Barra            Descrição             Status      Emp. Origem   Localização   Responsável   C. Custo      It. Contab.   Cl. Valor     Localização   Responsável   C. Custo      It. Contab.   Cl. Valor"
...
Local aStatus	:= { "Conciliado", "Divergente" , "Não Conci." }
...
aAdd(aRegs,{cPerg,"05","Listar: "			,"mv_ch5","N",01,0,0,"C","","mv_par05","Conciliados","","","Divergentes","","","Não Conciliados","","","Todos","","","","","",""})
